...
export class File extends EE {
  ...
  async getFilesFromContent(
    ...
    return this.cache.get(this.cache.encode(query, "matrix"), () =>
      ChannelData.find({
        where: { entry_id },
        attributes: ["entry_id"],
        include: [
