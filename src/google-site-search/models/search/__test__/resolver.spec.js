...
it(
  "`SSSearchResult` should return the htmlTitle from the search result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
...
it(
  "`SSSearchResult` should return the displayLink from the search result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
...
it(
  "`SSSearchResult` should return the description from the search result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
...
it(
  "`SSSearchResult` should return the htmlDescription from the search result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
...
it(
  "`SSSearchResult` should return null for type if no pagemap in result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
...
it(
  "`SSSearchResult` should return null for type if no metatags in pagemap in result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
...
it(
  "`SSSearchResult` should return null for section if no pagemap in result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
    delete sampleItem.pagemap;
...
it(
  "`SSSearchResult` should return false if there is no image in the search result",
  () => {
    const { SSSearchResult } = Resolver;
    const sampleItem = generateSearchItem();
    delete sampleItem.pagemap;
