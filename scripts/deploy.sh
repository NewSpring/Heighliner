  ...
  task_template='[
    {
      ...
      "environment": [
        ...
        { "name": "MYSQL_SSL", "value": "'"$MYSQL_SSL"'" },
        { "name": "NEW_RELIC_KEY", "value": "'"$NEW_RELIC_KEY"'" },
        { "name": "PORT", "value": "'"$PORT"'" },
        { "name": "ROCK_URL", "value": "'"$ROCK_URL"'" },
        { "name": "ROCK_TOKEN", "value": "'"$ROCK_TOKEN"'" },
        { "name": "SEARCH_URL", "value": "'"$SEARCH_URL"'" },
        { "name": "SEARCH_CX", "value": "'"$SEARCH_CX"'" },
        { "name": "SEARCH_KEY", "value": "'"$SEARCH_KEY"'" },
        { "name": "MSSQL_HOST", "value": "'"$MSSQL_HOST"'" },
        { "name": "MSSQL_USER", "value": "'"$MSSQL_USER"'" },
        { "name": "MSSQL_PASSWORD", "value": "'"$MSSQL_PASSWORD"'" },
        { "name": "MSSQL_DB", "value": "'"$MSSQL_DB"'" },
        { "name": "MSSQL_INSTANCE", "value": "'"$MSSQL_INSTANCE"'" }
      ]
    }
  ]'
